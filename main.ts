...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(monstro, effects.fire, 100)
})
let monstro: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
casa.setPosition(160, 57)
controller.moveSprite(mira)
mira.setStayInScreen(true)
game.onUpdateInterval(2000, function () {
    monstro = sprites.create(img`
        . . . . b b b b . . . . . . . . 
        . . . b 3 3 3 3 b b b b . . . . 
        ...
        `, SpriteKind.Enemy)
    monstro.setPosition(0, randint(20, 100))
    monstro.setVelocity(20, 0)
})
